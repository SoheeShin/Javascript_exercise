...
//return the string false. Only these two letters will be entered in the string, no 
//punctuation or numbers. For example: if str is "xooxxxxooxo" then the output should 
